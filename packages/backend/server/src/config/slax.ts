...
//
// ###############################################################
// ##                slax Configuration System                ##
// ###############################################################
// Here is the file of all slax configurations that will affect runtime behavior.
...
//   3. apply `./slax.ts` patches (this file)
//   4. apply `./slax.env.ts` patches
//
//
// ###############################################################
// ##                       General settings                    ##
...
// slax.serverId = 'some-randome-uuid';
//
// /* The name of slax Server, may show on the UI */
// slax.serverName = 'Your Cool slax Selfhosted Cloud';
//
...
// /* For example, if you set `slax.path = '/slax'`, then the server will be available at `${domain}/slax` */
// slax.path = '/slax';
//
//
// ###############################################################
...
// ###############################################################
//
// /* The URL of the database where most of slax server data will be stored in */
// slax.db.url = 'postgres://user:passsword@localhost:5432/slax';
//
//
// ###############################################################
...
// slax.metrics.enabled = true;
//
// /* Authentication Settings */
// /* Whether allow anyone signup */
// slax.auth.allowSignup = true;
//
...
// /* Useful when you deploy slax server in a cluster. */
...
// slax.plugins.use('aws-s3', {
//  credentials: {
//    accessKeyId: '',
//    secretAccessKey: '',
// })
// /* Update the provider of storages */
// slax.storage.storages.blob.provider = 'r2';
// slax.storage.storages.avatar.provider = 'r2';
//
// /* OAuth Plugin */
