...
const SELF_HOST_CONFIG_DIR = '/root/.slax/config';
/**
 * @type {Array<{ from: string; to?: string, modifier?: (content: string): string }>}
 */
const configFiles = [
  { from: './.env.example', to: '.env' },
  { from: './dist/config/slax.js', modifier: configCleaner },
  { from: './dist/config/slax.env.js', modifier: configCleaner },
];
